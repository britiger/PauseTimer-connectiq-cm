...
// TODO: Put in Module, but not worked when calling Module in Background:
// Error: Illegal Access (Out of Bounds)
// Details: Failed invoking <symbol>
//

// Need to be define as Background, if not you'll get the "Illegal Access" error
(:background)
class CriticalMapsAPI {
    //const BASEURL = "http://192.168.0.8:8088/"; // Test 
    static const BASEURL = "https://api.criticalmaps.net/";

    static var lastResponse = -1;
    static var numResponse = 0;
    static var lastLocation = {};
    static var nearestCM = 0;
    static var countCM10 = 0;
    static var chatText = "";
    ...
    static function callbackCM(responseCode, data) {
        System.println(lastLocation);
    ...
    static function parseChat(data) {
    ...
    static function distanceToLastLocation(lat2, lon2) {
        // TODO: Check values
      ...
      static function stringReplace(str, find, replace) {
          var result = str;
    ...
    static function MathMin(val1, val2) {
